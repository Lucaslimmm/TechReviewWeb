...
$st1='0';
$query=mysqli_query($con,"insert into newscomments(postId,name,comment,status) values('$postid','$name','$comment','$st1')");
if($query):
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-items-center">
                        <h1 class="text-white font-weight-bold">TechReview News</h1>
                    </div>
                </div>
            </div>
        </header>
...
<?php } ?>
   ...
   <?php 
   $sts=1;
   $query=mysqli_query($con,"select name,comment,postingDate from  newscomments where postId='$pid' and status='$sts'");
   while ($row=mysqli_fetch_array($query)) {
   ?>
   <div class="card-body">
